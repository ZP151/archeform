...
export function FactorySheet({ open, onOpenChange, restoreFocusId, initialFocusId, title, description, side = 'right', overlay = 'dim', modal, children }: ChildrenProps & { open: boolean; onOpenChange: (open: boolean) => void; restoreFocusId?: string; initialFocusId?: string; title: string; description?: string; side?: 'right' | 'left' | 'top' | 'bottom' | 'floating' | 'center'; overlay?: 'dim' | 'clear' | 'none'; modal?: boolean }) {

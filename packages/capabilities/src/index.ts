...
> = Object.freeze({
  "simple-ecommerce": Object.freeze({ order: "2.1.0", transaction: "2.2.0" }),
  "retail-counter": Object.freeze({ order: "2.1.0", transaction: "2.2.0" }),
  "grocery-pickup": Object.freeze({ order: "2.1.0", transaction: "2.2.0" }),
});

...
export const restaurantTableSessionAsset: CapabilityAssetV1 = {
  manifest: {
    ...
    packageRoot: "packages/capabilities/assets/restaurant.table-session/1.0.0",
    manifestDigest:
      "sha256:c10552e3515ae5b0e3f6fdb3cb6fe6f7f6ac028f7a258a7901cb2ee59c058618",
    lifecycle: "golden",
    ...
    inputSchema: [
      ...
      { key: "tokenTtl", type: "duration", required: false },
    ],
    outputSlots: [
      "api.runtime",
      "api.command",

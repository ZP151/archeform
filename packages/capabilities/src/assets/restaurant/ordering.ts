...
export const restaurantOrderingAsset: CapabilityAssetV1 = {
  manifest: {
    ...
    packageRoot: "packages/capabilities/assets/restaurant.ordering/1.0.0",
    manifestDigest:
      "sha256:98d68f6d56678c1e2c67871c29dc0662b55dbe4fd8d482c8ddf41637bb7d1401",
    lifecycle: "golden",
    ...
    inputSchema: [
      ...
      { key: "idempotencyHeader", type: "http.header", required: true },
    ],
    outputSlots: [
      "api.runtime",
      "api.command",

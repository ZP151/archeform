...
const createRequestSchema = z.object({ orderId: z.string().min(1) }).strict();
...
export type CommerceOrderCreateRequestV1 = z.infer<typeof createRequestSchema>;
export type CommerceOrderTransitionRequestV1 = z.infer<
  typeof transitionRequestSchema
>;

export function createCommerceOrderCreateHandler() {
  return Object.freeze({
    parseRequest(request: unknown): CommerceOrderCreateRequestV1 {
      return createRequestSchema.parse(request);
    },
    create(request: CommerceOrderCreateRequestV1) {
      return Object.freeze({
        id: request.orderId,
...
export function createCommerceOrderLifecycleOperationAdapter() {
  return Object.freeze({
    parseRequest(request: unknown): CommerceOrderTransitionRequestV1 {
      return transitionRequestSchema.parse(request);
    },
    prepare(request: CommerceOrderTransitionRequestV1) {
      return Object.freeze({
...
export const orderAssetV2_0_0: CapabilityAssetV1 = {
  manifest: {
    ...
    description:
      "Creates validated initial order drafts and prepares bounded order transitions.",
    packageRoot: "packages/capabilities/assets/commerce.order/2.0.0",
    manifestDigest:
      "sha256:bf648fa163ef4c7134aede67a7cea1748967b8e7f876c01f5c2bfd966fff4374",
    lifecycle: "golden",
    ...
    executableContributions: [
      {
        ...
        digest:
          "sha256:bacdef7aad235d0b31d6e1060489c5143a6516b561525fbcc2a39bf43496a21a",
      },
      {
        ...
        mergeProtocol: "replace-file",
        digest:
          "sha256:eaf11fdaf83df17b4a061c025bd39a280221f39876b743192c5eed82afbdcda0",
      },
      {
        ...
        mergeProtocol: "replace-file",
        digest:
          "sha256:682ddae219a6abd1fe8b3173d0d0aeceb37592c1a138eb623c0eec7f03d46d0a",
      },
    ],
    provides: [
    ...
    verification: {
      ...
      contractTestDigest:
        "sha256:06ee91d1fac61df116531a94964d452356ca5ae04b5d1a2fdceb3a807a9259a0",
      status: "verified",
    },
  },
};

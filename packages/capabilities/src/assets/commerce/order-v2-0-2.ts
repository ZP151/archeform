...
export type CommerceOrderCreateRequestV2_0_2 = z.infer<
  typeof createRequestSchema
>;
export type CommerceOrderCreatedV2_0_2 = Readonly<{
  readonly id: string;
  readonly status: string;
  readonly version: 0;
}>;
export type CommerceOrderTransitionRequestV2_0_2 = z.infer<
  typeof transitionRequestSchema
>;

export interface CommerceOrderCreateStoreV2_0_2 {
  createInitial(
    input: Readonly<Record<string, unknown>>,
  ): Promise<CommerceOrderCreatedV2_0_2>;
}

export interface CommerceOrderCreateAuthorizerV2_0_2 {
  assertCreateAllowed(role: string): Promise<void>;
}

export function createCommerceOrderCreateHandlerV2_0_2() {
  return Object.freeze({
    async create(
      request: CommerceOrderCreateRequestV2_0_2,
      dependencies: Readonly<{
        store: CommerceOrderCreateStoreV2_0_2;
        authorizer: CommerceOrderCreateAuthorizerV2_0_2;
      }>,
    ): Promise<CommerceOrderCreatedV2_0_2> {
...
export function createCommerceOrderLifecycleOperationAdapterV2_0_2() {
  return Object.freeze({
    parseRequest(request: unknown): CommerceOrderTransitionRequestV2_0_2 {
      return transitionRequestSchema.parse(request);
    },
    prepare(request: CommerceOrderTransitionRequestV2_0_2) {
      return Object.freeze({
...
export const orderAssetV2_0_2: CapabilityAssetV1 = {
  manifest: {
    ...
    packageRoot: "packages/capabilities/assets/commerce.order/2.0.2",
    manifestDigest:
      "sha256:57dad2321a647302e013f3ac8bc12c7df66dcd3e7f75d566440a03ec1e08c8cd",
    lifecycle: "golden",
    ...
    executableContributions: [
      {
        ...
        digest:
          "sha256:616a161e958f58e8b14bc4c8829e3963c6fc462e2ea20fdbd0cff16d136e5cf6",
      },
      {
        ...
        mergeProtocol: "replace-file",
        digest:
          "sha256:c4ba3b2dd8e893ec860cedc3757532cbd4380e2f208326257e4c2368b8d3ce6e",
      },
      {
        ...
        mergeProtocol: "replace-file",
        digest:
          "sha256:8d9bf8fbb11ca1401abd7be1e880db3d4364c79c46a0e125b92676bc4588e872",
      },
    ],
    provides: [
    ...
    verification: {
      ...
      contractTestDigest:
        "sha256:9bc46ed97110f0467223cc46930031b759a7529f26ff65814133d83820eed59d",
      status: "verified",
    },
  },
};

...
export const orderOperationsAssetV1_0_0: CapabilityAssetV1 = {
  manifest: {
    ...
    packageRoot: "packages/capabilities/assets/commerce.order-operations/1.0.0",
    manifestDigest:
      "sha256:68be0cea75312d963b380512650a462cf9fd2f81d1ef6a07d4b0a88de633521f",
    lifecycle: "golden",
    profiles: [
      "restaurant-ordering",
      "simple-ecommerce",
    ...
    templates: [
      {
        ...
        digest:
          "sha256:dc348365a646d2298ce558ea66b5903561225324cc00bf14d74687a3cdf1ffeb",
      },
    ],
    parameters: [

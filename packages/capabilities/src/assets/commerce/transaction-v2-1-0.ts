...
export const commerceTransactionAssetV2_1_0: CapabilityAssetV1 = {
  manifest: {
    ...
    version: "2.1.0",
    category: "commerce",
    name: "Commerce transaction executor with operation adapter",
    description:
      "Executes idempotent, version-checked commerce commands through a lock-governed atomic boundary and exactly one typed operation adapter.",
    packageRoot: "packages/capabilities/assets/commerce.transaction/2.1.0",
    manifestDigest:
      "sha256:7ca669503257fc4378b039126001201b781e8b6a9ce51184a63620fbe3181309",
    lifecycle: "golden",
    profiles: [
      "restaurant-ordering",
      "simple-ecommerce",
    ...
    executableContributions: [
      {
        ...
        digest:
          "sha256:6fee5ae6c304d2e6b665f8c990fdf80de4a22a60350a7079603264724454ecb5",
      },
      {
        ...
        digest:
          "sha256:572b47cd18dad9271e1291a8f7136ce9cea1ea4fd848c7703bb805cc4d222afb",
      },
      {
        ...
        mergeProtocol: "append-fragment",
        digest:
          "sha256:67596570db6b51c602f66b46077c4c7933f608d0bb868b6cea854f33e6c482e9",
      },
      {
        ...
        mergeProtocol: "replace-file",
        digest:
          "sha256:1f3dafa0483911be7b5d0280f08907eb64c76664c770a5fca82edd9555d51c8a",
      },
    ],
    requires: [
    ...
    verification: {
      ...
      fixtureDigest:
        "sha256:150e46e0d2e0df646a09d3b4fcce42a7d50626f35aae681b0b4255478031a07c",
      contractTest: "tests/contract.json",
      contractTestDigest:
        "sha256:dc5ebda1f2e87b7c1ce0d59dde8931c784c538d598a0f4eba6e0cf3b1dd19215",
      status: "verified",
    },
  },
};

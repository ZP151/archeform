...
export const lineConfigurationAssetV1_1_0: CapabilityAssetV1 = {
  manifest: {
    ...
    description:
      "Declares bounded product options, price snapshots, and server-authoritative configured lines.",
    packageRoot:
      "packages/capabilities/assets/commerce.line-configuration/1.1.0",
    manifestDigest:
      "sha256:9999dbf859dc16967802714ff72a8f84200c1b213b4e3e517a940e38438eb076",
    lifecycle: "golden",
    profiles: [
      "restaurant-ordering",
      "simple-ecommerce",
    ...
    templates: [
      {
        ...
        digest:
          "sha256:68a4cc37dd44ecdddceb960ab33f4ec67899807d65b71dd4699ad8251b3b14f4",
      },
    ],
    parameters: [

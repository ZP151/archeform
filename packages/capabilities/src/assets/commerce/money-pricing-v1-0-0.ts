...
export const moneyPricingAssetV1_0_0: CapabilityAssetV1 = {
  manifest: {
    ...
    name: "Money pricing",
    description:
      "Calculates immutable server-authoritative price snapshots and deterministic refund allocations.",
    packageRoot: "packages/capabilities/assets/commerce.money-pricing/1.0.0",
    manifestDigest:
      "sha256:9b3d0365c42c7cd823f49c754fc6992f61172afe47bc33c33bb2aec42c923bed",
    lifecycle: "golden",
    ...
    templates: [
      {
        ...
        digest:
          "sha256:4fa8753700291e738ac02e36cf45e7a5e7e21d7528463e551bb74af523a8c165",
      },
    ],

...
export const lineConfigurationAssetV1_0_0: CapabilityAssetV1 = {
  manifest: {
    ...
    description:
      "Validates bounded item options and computes configured line prices on the server.",
    packageRoot:
    ...
    graphContributions: [
      {
        ...
        digest:
          "sha256:e871d8aa4247e16097f88fdecfd2d0ccb9260b8da6bbab60f497a7a26eaa172e",
      },
      {
        id: "configured-line-pages",
        model: "page",
        collection: "pages",
        operation: "extend",
        parameterRefs: ["catalogPage", "merchantPage"],
        digest:
          "sha256:2d90947cde1cc4a6040c98f484fee2ed6ae5a813a6be9f822f30cdda516dfb89",
      },
    ],
    executableContributions: [
      {
        id: "line-configuration-service",
        outputSlot: "api.service",
        namespace: "packages/commerce.line-configuration/api/services/",
        source: "templates/api/line-configuration.service.ts.tpl",
        target: "api/src/services/{{lineEntity}}-line-configuration.service.ts",
        parameterRefs: [
          "catalogEntity",
          "lineEntity",
          "optionGroupEntity",
        ...
        digest:
          "sha256:e23d1e5d5ffbee9fc0399c6d2458638d5160c140b7017696874b3fbf5512f630",
      },
    ],
    requires: [

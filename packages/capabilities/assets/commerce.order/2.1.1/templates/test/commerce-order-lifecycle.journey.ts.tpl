...
import { createCommerceOrderTransactionOperationAdapter } from "../../src/capabilities/commerce-order-transaction-operation-adapter.js";

const commerceOrderTransactionOperationAdapter =
  createCommerceOrderTransactionOperationAdapter(["submit"]);

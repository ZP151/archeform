...
> {
  ...
  const adapter: TransactionOperationAdapterV2<
    CommerceOrderTransactionRequestV2,
    CommerceOrderTransactionContextV2,
    OrderTransitionReceipt
  > = {
    ...
    createStore(
      _context: CommerceOrderTransactionContextV2,
    ...
    present(
      result: TransactionResultV2,
      context: CommerceOrderTransactionContextV2,
    ) {

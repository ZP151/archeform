...
| D    | Customer Requests / Support | Desktop triage; mobile customer request/status                      | Submit, respond, resolve, reopen with clear ownership and privacy boundary                                                                                                                     | Runtime/UI/worker/definition/consumer case source accepted; actual and hosted acceptance remain open      |
| E    | Event Registration          | Mobile discovery/registration; desktop attendee management          | Capacity, individual and whole-event cancellation, check-in and correction; retain unsupported payment/notification requirements                                                               | Task 1 contract source accepted; finish delivery then wait for founder acceptance; no new delivered count |

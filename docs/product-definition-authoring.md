...
Its seven registered entries supply canonical requirements/blueprints and selection
...
Current catalogue assertions explicitly name seven keys. A separate current-six
